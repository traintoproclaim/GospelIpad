...
- (void)viewDidLoad
{
    ...
    [image setImage:[UIImage imageNamed:@"idolaters@1x.png"]];
    ...
    switch (value22)
    {
        ...
        case 2: image.hidden=YES;
            ...
            if([str isEqualToString:@"1"])
            {
                ...
                lb12=CGRectMake(370,220, 262, 188);
            ...
            } if([str isEqualToString:@"1"])
            {
                ...
                [image4 setImage:[UIImage imageNamed:@"idolaters_gray@1x.png"]];
                [self.view addSubview:image4];
                
                lb11=CGRectMake(370, 400, 262,188);
            ...
            } else
            {
                ...
                lb11=CGRectMake(370, 260, 262, 188);
                image7=[[UIImageView alloc]initWithFrame:lb11];
                [image7 setImage:[UIImage imageNamed:@"guilty_small@1x.png"]];
                [self.view addSubview:image7];
...
-(void)callgiltyanimation
{
    ...
    image1.animationImages =[NSArray arrayWithObjects:
                             [UIImage imageNamed:@"guilty1@1x.png"],
                             [UIImage imageNamed:@"guilty2@1x.png"],
