...
@implementation StartScreen5
@synthesize image,lable1,lable2,lable3,image1,image2,back,text;
int value5=1;
...
- (void)viewDidLoad
{
    ...
    lb1=CGRectMake(120,250, 800,140);
    image=[[UIImageView alloc]initWithFrame:lb1];
    [image setImage:[UIImage imageNamed:@"liers@1x.png"]];
    ...
    [lable2 setTitle:@"Technically that makes us both LIARS."forState:UIControlStateNormal];
...
-(void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    switch (value5)
    {
        ...
        case 2:
            ...
            NSUserDefaults *perf=[NSUserDefaults standardUserDefaults];
            [perf setObject:@"1" forKey:@"next2"];
            tab1=[[StartScreen7 alloc]initWithNibName:@"StartScreen7" bundle:[NSBundle mainBundle]];            [self.navigationController pushViewController:tab1 animated:NO];
            [tab1 release];  
            break; 
